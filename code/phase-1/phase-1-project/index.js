...
//database.loardDatabase();
//let allstudents = [];
   //function WrapStudents (){
    //let studentListInput = document.getElementById ('Stlist');
    //console.log(studentListInput.value);
    //allstudents.push(studentListInput.value)
   // console.log(allstudents);
    
   //} 

//function WrapStudents(){
  //let studentList = document.getElementById ('Stlist');
  //console.log (studentList.value);
  //let fullList = []
 // fullList.push(studentList.value );
...
// The Headers { registration , signIn , About, Contact}
 ...
 function studentSignIn (){
   ...
   // const inCampus = document.getElementById('"campus"');
//inCampus.addEventListener( "loadstart",)
   ...
   //function accounteCondition (){
    //let accounte = document.getElementById("accounte");
    //let restriction = confirm('Only Institutions can create an accounte! Members of Institution can only sign in with the details their Intitution attributed to them ! If you are an Intstitution, click ok to continue!');
    //if (restriction == false){
